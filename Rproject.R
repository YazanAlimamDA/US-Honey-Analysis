...
vec = c(1995:2017)
for(i in vec){
  x = ((subset(h, h$year == i, c(average_price, year, state))))
  
  avgprice =  x$average_price / 100
  
  barplot(avgprice,col = c("blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue",
                           "blue","blue","blue", "blue", "red"),ylab = "Average Price Per Pound of Honey in Dollars ", main = c("Honey Cost per pound timelapse 1995 --> 2021","\n",i))
...
vec2 = c(2018:2021)
for(j in vec2){
  x = ((subset(h, h$year == j, c(average_price, year, state))))
  
  avgprice2 =  x$average_price 
  
  barplot(avgprice2,col = c("blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue","blue",
                            "blue","blue","blue", "blue", "red"), ylab = "Average Price Per Pound of Honey in Dollars ", main = c("Honey Cost per pound timelapse 1995 --> 2021","\n",j))
  
  Sys.sleep(1)
}
# Has inflation affected honey prices per pound from 1995 to 2021 in the U.S.?
# Yes it has had a great affect on honey prices, one main reason could be the high demand on #honey, and how climate change has been contributing to the decline in pollinator populations.
#The altering weather patterns and the ruin it has had on the synchrony between flowering plants #and their pollinators cause nutritional stress for the bees, causing the prices of honey to rise.
#In conclusion, the main reason why the honey cost is rising is because of the global warming #we have on our planet today, and which has been a problem since 1995. 
